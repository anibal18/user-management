...
const updatedataemailschema=Type.Object({
    email,
    password,
},{
...
const validation= ajv.compile(updatedataemailschema);

const updatedataemail=(req , res ,next)=>{
...
export default updatedataemail;
